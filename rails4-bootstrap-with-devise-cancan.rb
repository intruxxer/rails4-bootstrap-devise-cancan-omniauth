...
gem 'bson'
gem 'bson_ext' #gem install bson_ext
...
inject_into_file 'config/initializers/devise.rb', after: /# config.omniauth .*?\n/ do
  <<-eos
  config.omniauth :facebook, '255468607938530', 'db9fcb2e31c1b8805016a65dc62e8c49', scope: 'email,user_birthday,read_stream'
  config.omniauth :twitter, 'KytXTpDaZUSnykquDXmQQ', 'Gi45zdqovy87trWPMubHCAwUPzjb9kXNpfvl1hDac'
  eos
end

### Download misc files
source_url = 'https://raw.github.com/intruxxer/rails4-bootstrap-devise-cancan-omniauth/master'
get "#{source_url}/app/assets/javascripts/application.js",                    'app/assets/javascripts/application.js'
...
get "#{source_url}/app/assets/stylesheets/sticky.css.scss",                   'app/assets/stylesheets/sticky.css.scss'
get "#{source_url}/app/assets/stylesheets/form.css.scss",                     'app/assets/stylesheets/form.css.scss'
...
get "#{source_url}/config/initializers/setup_mail.rb",                        'config/initializers/setup_mail.rb'
